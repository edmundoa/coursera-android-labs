...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		final Intent explicitIntent = new Intent(this, ExplicitlyLoadedActivity.class);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if ((requestCode == GET_TEXT_REQUEST_CODE) && (resultCode == RESULT_OK)) {
			mUserTextView.setText(data.getStringExtra(ExplicitlyLoadedActivity.USER_TEXT));
		}
	}
}
